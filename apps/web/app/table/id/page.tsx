      ...
      <section className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-xl">
        ...
        {phone ? (
          <div className="mt-7 flex justify-center">
            <QRCode value={waLink} size={220} includeMargin />
          </div>
        ) : (
          <div className="mt-7 rounded-xl bg-amber-50 p-4 text-sm text-amber-800">WhatsApp number is not configured yet.</div>
        )}
